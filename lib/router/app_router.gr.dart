...
import 'package:organisations/Forms/AddressForm.dart' as _i3;
import 'package:organisations/Forms/ContactForm.dart' as _i5;
import 'package:organisations/Forms/DocumentsForm.dart' as _i7;
import 'package:organisations/Forms/FunctionDocumentsForm.dart' as _i9;
import 'package:organisations/Forms/FunctionForm.dart' as _i8;
import 'package:organisations/Forms/IdentifierForm.dart' as _i6;
import 'package:organisations/Forms/OrganisationForm.dart' as _i4;
...
abstract class $AppRouter extends _i10.RootStackRouter {
  ...
  final Map<String, _i10.PageFactory> pagesMap = {
    ...
    AddressForm.name: (routeData) {
      ...
      return _i10.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: _i3.AddressForm(org: args.org),
      );
    },
    OrganisationForm.name: (routeData) {
      return _i10.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: _i4.OrganisationForm(),
      );
    },
    ContactForm.name: (routeData) {
      ...
      return _i10.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: _i5.ContactForm(args.org),
      );
    },
    IdentifierForm.name: (routeData) {
      ...
      return _i10.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: _i6.IdentifierForm(org: args.org),
      );
    },
    DocumentsForm.name: (routeData) {
      ...
      return _i10.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: _i7.DocumentsForm(org: args.org),
      );
    },
    ...
    FunctionDocumentsForm.name: (routeData) {
      ...
      return _i10.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: _i9.FunctionDocumentsForm(
